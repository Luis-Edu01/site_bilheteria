...
if (nome && nome2 && email && github && imagem) {
  ...
  document.getElementById("exibirNome2").textContent =
    "Nenhum nome encontrado.";
  document.getElementById("exibirEmail").textContent =
    "Nenhum e-mail encontrado.";
  document.getElementById("exibirGithub").textContent =
    "Nenhum GitHub encontrado.";
  document.getElementById("exibirImagem").alt = "Nenhuma imagem encontrada.";
}

function getRandomInt(min, max) {
  // Gera Número aleatório para Ticket criado
